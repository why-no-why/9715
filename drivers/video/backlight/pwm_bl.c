...
//==================================================================================
//fj_ltls add 20160413
#define BACKLINGHT_DBG(fmt, arg...) printk(KERN_INFO " backlight: " fmt "\n" , ## arg)
//#define BACKLINGHT_DBG(fmt, arg...)
//==================================================================================
...
static int pwm_backlight_update_status(struct backlight_device *bl)
{
	...
	if (pb->notify)
     ...
     BACKLINGHT_DBG("%s  : brightness=%d ",__func__,brightness);
